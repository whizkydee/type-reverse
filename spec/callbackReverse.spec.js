...
describe('number reverse via callback function', () => {
  it('should reverse a positive number and return stuff via the callback', () => {
  ...
  it('should reverse a negative number and return stuff via the callback', () => {
...
describe('array reverse via callback function', () => {
  it('should reverse an array and compare with the original via the callback', () => {
...
describe('callback function with optional paramters', () => {
  it('should take only the required parameters from the callback', () => {
    const arr = [1, 2, 3, 4];
